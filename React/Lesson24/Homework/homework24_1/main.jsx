...
Создайте приложение с тремя страницами:
    * главной страницей, соответстующей React компоненту App, содержащему 2 кнопки (ListView, TableView), реализующие переход
    * по соответственным путям (“/listView”, “tableView”)
...
* элементов массива users first_name, last_name и gender.
